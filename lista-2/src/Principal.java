...
public class Principal {
	public static int busca(int chave, int tamanho, Produto[] x) {
		//recebe uma chave e retorna uma posi��o do vetor e -1 se n�o encontrar
		int i;
		for(i = 0; i<tamanho; i++) {
			if(x[i].id == chave){
				return i;
	...
	public static void main(String[] args) {
		...
		while(op!=0) {
			op = Integer.parseInt(JOptionPane.showInputDialog("Deseja Realizar uma Opera��o ?\n"
											  + "0 - Sair\n"
											  + "1 - Vender\n" 
											  + "2 - Comprar\n"
											  + "3 - Consultar\n"
			...
			switch(op) {
				...
				case 4:
					//comparar
					chave2 = Integer.parseInt(JOptionPane.showInputDialog("Digite a chave do outro produto para ser feita a compara��o: "));
